...
function ANDROID_setup_env_func()
{
	...
	. build/envsetup.sh
        ...
        if [ "${CMD_V_BOARD}" = "tcc8050" ]; then
                lunch car_tcc8050_arm64-${CMD_V_MODE}
	fi
	echo -e "\n\n"
}
...
function ANDROID_bootloader_build_func()
{
	...
	if [ "${CMD_V_OS}" = "Android-10" ]; then
		...
		if [ "${CMD_V_BOARD}" = "tcc8050" ]; then
			./scripts/kconfig/merge_config.sh -n .config ../../../device/telechips/car_tcc8050_arm64/gpu_cfg/gpu-vz.cfg
		fi		
	fi
...
function ANDROID_System_build_func()
{
	...
	if [ "${CMD_V_BOARD}" = "tcc8050" ]; then
		cd device/telechips/car_tcc8050_arm64
		...
		if [ "${CMD_V_BOARD_VER}" = "evb_sv0.1" ]; then
			sed -i "s/${CMD_V_BOARD}-android-lpd4x322_sv1.0.dtb/${CMD_V_BOARD}-android-lpd4x322_sv0.1.dtb/g" device/telechips/car_tcc8050_arm64/BoardConfig.mk
			sed -i "s/${CMD_V_BOARD}-android-lpd4x322_sv1.0.dtb/${CMD_V_BOARD}-android-lpd4x322_sv0.1.dtb/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64_ab.list
			sed -i "s/${CMD_V_BOARD}-android-lpd4x322_sv1.0.dtb/${CMD_V_BOARD}-android-lpd4x322_sv0.1.dtb/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64.list
                        sed -i "s/${CMD_V_BOARD}-android-lpd4x322_sv1.0.dtb/${CMD_V_BOARD}-android-lpd4x322_sv0.1.dtb/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64_ab_dp.list
			sed -i "s/${CMD_V_BOARD}-linux-subcore_sv1.0-${CMD_V_BOARD}-sub.dtb/${CMD_V_BOARD}-linux-subcore_sv0.1-${CMD_V_BOARD}-sub.dtb/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64.list
			sed -i "s/${CMD_V_BOARD}-linux-subcore_sv1.0-${CMD_V_BOARD}-sub.dtb/${CMD_V_BOARD}-linux-subcore_sv0.1-${CMD_V_BOARD}-sub.dtb/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64_ab.list
                        sed -i "s/${CMD_V_BOARD}-linux-subcore_sv1.0-${CMD_V_BOARD}-sub.dtb/${CMD_V_BOARD}-linux-subcore_sv0.1-${CMD_V_BOARD}-sub.dtb/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64_ab_dp.list
		else
			sed -i "s/${CMD_V_BOARD}-android-lpd4x322_sv0.1.dtb/${CMD_V_BOARD}-android-lpd4x322_sv1.0.dtb/g" device/telechips/car_tcc8050_arm64/BoardConfig.mk
			sed -i "s/${CMD_V_BOARD}-android-lpd4x322_sv0.1.dtb/${CMD_V_BOARD}-android-lpd4x322_sv1.0.dtb/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64_ab.list
			sed -i "s/${CMD_V_BOARD}-android-lpd4x322_sv0.1.dtb/${CMD_V_BOARD}-android-lpd4x322_sv1.0.dtb/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64.list
                        sed -i "s/${CMD_V_BOARD}-android-lpd4x322_sv0.1.dtb/${CMD_V_BOARD}-android-lpd4x322_sv1.0.dtb/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64_ab_dp.list
			sed -i "s/${CMD_V_BOARD}-linux-subcore_sv0.1-${CMD_V_BOARD}-sub.dtb/${CMD_V_BOARD}-linux-subcore_sv1.0-${CMD_V_BOARD}-sub.dtb/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64.list
			sed -i "s/${CMD_V_BOARD}-linux-subcore_sv0.1-${CMD_V_BOARD}-sub.dtb/${CMD_V_BOARD}-linux-subcore_sv1.0-${CMD_V_BOARD}-sub.dtb/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64_ab.list
		fi
	fi
	if [ "${CMD_V_BOARD}" = "tcc8050" ]; then
		cd device/telechips/car_tcc8050_arm64
		...
		croot
		if [ "${CMD_V_BOARD_VER}" = "evb_sv0.1" ]; then
			sed -i "s/${TEMP_V_BOARD}-android-lpd4x322_sv1.0.dtb/${CMD_V_BOARD}-android-lpd4x322_sv0.1.dtb/g" device/telechips/car_tcc8050_arm64/BoardConfig.mk
			sed -i "s/${TEMP_V_BOARD}-android-lpd4x322_sv1.0.dtb/${CMD_V_BOARD}-android-lpd4x322_sv0.1.dtb/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64_ab.list
			sed -i "s/${TEMP_V_BOARD}-android-lpd4x322_sv1.0.dtb/${CMD_V_BOARD}-android-lpd4x322_sv0.1.dtb/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64.list
			sed -i "s/${TEMP_V_BOARD}-linux-subcore_sv1.0-${TEMP_V_BOARD}-sub.dtb/${CMD_V_BOARD}-linux-subcore_sv0.1-${CMD_V_BOARD}-sub.dtb/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64.list
			sed -i "s/${TEMP_V_BOARD}-linux-subcore_sv1.0-${TEMP_V_BOARD}-sub.dtb/${CMD_V_BOARD}-linux-subcore_sv0.1-${CMD_V_BOARD}-sub.dtb/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64_ab.list
		else
			sed -i "s/${TEMP_V_BOARD}-android-lpd4x322_sv1.0.dtb/${CMD_V_BOARD}-android-lpd4x322_sv1.0.dtb/g" device/telechips/car_tcc8050_arm64/BoardConfig.mk
			sed -i "s/${TEMP_V_BOARD}-android-lpd4x322_sv1.0.dtb/${CMD_V_BOARD}-android-lpd4x322_sv1.0.dtb/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64_ab.list
			sed -i "s/${TEMP_V_BOARD}-android-lpd4x322_sv1.0.dtb/${CMD_V_BOARD}-android-lpd4x322_sv1.0.dtb/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64.list
			sed -i "s/tc-boot-${TEMP_V_BOARD}-sub.img/tc-boot-${CMD_V_BOARD}-sub.img/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64.list
			sed -i "s/tc-boot-${TEMP_V_BOARD}-sub.img/tc-boot-${CMD_V_BOARD}-sub.img/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64_ab.list
			sed -i "s/${TEMP_V_BOARD}-linux-subcore_sv1.0-${TEMP_V_BOARD}-sub.dtb/${CMD_V_BOARD}-linux-subcore_sv1.0-${CMD_V_BOARD}-sub.dtb/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64.list
			sed -i "s/${TEMP_V_BOARD}-linux-subcore_sv1.0-${TEMP_V_BOARD}-sub.dtb/${CMD_V_BOARD}-linux-subcore_sv1.0-${CMD_V_BOARD}-sub.dtb/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64_ab.list
			sed -i "s/telechips-subcore-image-${TEMP_V_BOARD}-sub.ext/telechips-subcore-image-${CMD_V_BOARD}-sub.ext/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64.list
			sed -i "s/telechips-subcore-image-${TEMP_V_BOARD}-sub.ext/telechips-subcore-image-${CMD_V_BOARD}-sub.ext/g" device/telechips/car_tcc8050_arm64/gpt_partition_for_arm64_ab.list
	...
	if [ "${CMD_V_GPU}" = "Yes" ]; then
		sed -i 's/TCC_GPU_VZ ?= false/TCC_GPU_VZ ?= true/g' device/telechips/car_tcc8050_arm64/device.mk
	else
		sed -i 's/TCC_GPU_VZ ?= true/TCC_GPU_VZ ?= false/g' device/telechips/car_tcc8050_arm64/device.mk
	fi

	if [ "${CMD_V_STORAGE}" = "UFS" ]; then
		sed -i 's/TCC_UFS_SUPPORT := false/TCC_UFS_SUPPORT := true/g' device/telechips/car_tcc8050_arm64/device.mk
	else
		sed -i 's/TCC_UFS_SUPPORT := true/TCC_UFS_SUPPORT := false/g' device/telechips/car_tcc8050_arm64/device.mk
	fi

	if [ "${CMD_V_STR}" = "Yes" ]; then
		sed -i 's/persist.vendor.tcc.suspend_to_ram = false/persist.vendor.tcc.suspend_to_ram = true/g' device/telechips/car_tcc8050_arm64/device.mk
	else
		sed -i 's/persist.vendor.tcc.suspend_to_ram = true/persist.vendor.tcc.suspend_to_ram = false/g' device/telechips/car_tcc8050_arm64/device.mk
	fi
...
function SUBCORE_Image_Copy_func()
{
	...
	cp build/${CMD_V_SUB_MACHINE}/tmp/deploy/images/${CMD_V_SUB_MACHINE}/ca53_bl3.rom ../maincore/device/telechips/car_tcc8050_arm64/${TEMP_V_SUBCORE_IMAGE}
	cp build/${CMD_V_SUB_MACHINE}/tmp/deploy/images/${CMD_V_SUB_MACHINE}/tc-boot-${CMD_V_SUB_MACHINE}.img ../maincore/device/telechips/car_tcc8050_arm64/${TEMP_V_SUBCORE_IMAGE}
	cp build/${CMD_V_SUB_MACHINE}/tmp/deploy/images/${CMD_V_SUB_MACHINE}/${TEMP_V_SUB_MACHINE}-linux-subcore_sv*-${CMD_V_SUB_MACHINE}.dtb ../maincore/device/telechips/car_tcc8050_arm64/${TEMP_V_SUBCORE_IMAGE}
	cp build/${CMD_V_SUB_MACHINE}/tmp/deploy/images/${CMD_V_SUB_MACHINE}/telechips-subcore-image-${CMD_V_SUB_MACHINE}.ext4 ../maincore/device/telechips/car_tcc8050_arm64/${TEMP_V_SUBCORE_IMAGE}
...
function ANDROID_fai_build_func
{
	...
	if [ "${CMD_V_GPU}" = "Yes" ]; then
		cp device/telechips/car_tcc8050_arm64/subcore_cluster/*.rom* bootable/bootloader/u-boot
		cp device/telechips/car_tcc8050_arm64/subcore_cluster/* out/target/product/car_${TEMP_V_BOARD}_${CMD_V_PLATFORM}
	else
		cp device/telechips/car_tcc8050_arm64/subcore/*.rom* bootable/bootloader/u-boot
		cp device/telechips/car_tcc8050_arm64/subcore/* out/target/product/car_${TEMP_V_BOARD}_${CMD_V_PLATFORM}
	fi
	...
	do
		...
		if [ "${LOCAL_V_KEY_PATH}" != "" ]; then
			...
			if [ "${TEMP_V_BOARD}" = "tcc803xp" ]; then
				...
				$LOCAL_V_KEY_PATH/tcSignTool_v3 secfw ../../../../device/telechips/car_tcc8050_arm64/subcore_cluster/ca53_bl3.rom ../../../../device/telechips/car_tcc8050_arm64/subcore_cluster/ca53_bl3.rom.signed $LOCAL_V_KEY_PATH/master.key $LOCAL_V_KEY_PATH/image.key
				$LOCAL_V_KEY_PATH/tcSignTool_v3 secfw ../../../../device/telechips/car_tcc8050_arm64/subcore_cluster/tc-boot-${TEMP_V_BOARD}-sub.img ../../../../device/telechips/car_tcc8050_arm64/subcore_cluster/tc-boot-${TEMP_V_BOARD}-sub.img.signed $LOCAL_V_KEY_PATH/master.key $LOCAL_V_KEY_PATH/image.key
